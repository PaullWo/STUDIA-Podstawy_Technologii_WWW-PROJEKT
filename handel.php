        ...
        <div class="okno_glowne">
            ...
            <article>
                <div class="nad_article" id="nad_article_gangi">
                    <div class="article_post lista_gang" id="sludzy">
                        <h4>DOSTĘPNI NA RYNKU</h4>
                        <div class="scroll_sludzy">
                            <?php
                                $sql="SELECT * FROM sludzy";
                                ...
                                while($row=$result->fetch_object()){
                                    ...
                                    $cena=$row->cena;
                                    $opis=$row->opis;
                                    $wlasciciel=$row->idWlasciciela;
                                    if($wlasciciel==0){
                                        echo "<div class='uzytkownik'><div><img src='$wyglad' class='profil_img'><div>imię: $imie <br>opis: $opis <br> cena: $cena <img src='grafika/coin.png'class='coins'><br></div>
                                        </div><a href='kupno.php?id=".$id."&cena=".$cena."' class='button'>Kup</a></div>";
                                    }
                                }
                            ?>
                        </div>
